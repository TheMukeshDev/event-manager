  ...
  return (
    <section className="section-spacing px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <motion.div
        ...
        transition={{ duration: 0.6 }}
      >
        <h2 className="heading-lg gradient-cyan-blue mb-4 break-words px-2 sm:px-0">Tech HUB BBS Stages & Timeline</h2>
      ...
      >
        {/* Vertical line */}
        <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-1 bg-linear-to-b from-cyan-500 to-blue-500 transform md:-translate-x-1/2" />
