...
export const EVENT_DATA = {
  ...
  description: 'Tech Hub BBS is a student-led tech community focused on building skills, organizing coding events, hackathons, and sharing real opportunities. We aim to create an environment where students can learn, compete, and grow together through practical exposure and innovation. 📍 BBSCET Prayagraj • 🚀 Events | Coding | Workshops | Opportunities',
  mode: 'Online',
  date: '14 April 2026',
