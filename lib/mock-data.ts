...
export const mockFAQs: FAQ[] = [
  {
    ...
    answer: 'The registration deadline is 14 April 2026 at 6:00 PM IST (same time as quiz start). Register before this date to participate in the quiz challenge.',
